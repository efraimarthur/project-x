        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav d-flex w-100 bg-prima/ry justify-content-end fw-semibold gap-3">
              <Link class="nav-link active text-white" aria-current="page" href="/login/Ppdb/messege">
          ...
          <div className="mx-3">
            <Link href="/login/Ppdb/home" className="text-decoration-none color red fw-bold text-info">
          ...
          <tr>
            ...
            <td>
              <Link href="/login/siswa/baru" className="text-decoration-none color red fw-bold text-info" target={"_blank"}>
                <button className="btn btn-primary">Validasi</button>
              </Link>
            </td>
          </tr>
          <tr>
