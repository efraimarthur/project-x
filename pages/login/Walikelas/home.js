    ...
    <div className=" bg-home-guru ">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav d-flex w-100 bg-prima/ry justify-content-end fw-semibold gap-3">
              <Link class="nav-link active text-white" aria-current="page" href="/login/Walikelas/messege">
          ...
          <div className="mx-3">
            <Link href="/login/Walikelas/verifikasi" className="text-decoration-none color red fw-bold text-white">
          ...
          <div className="mx-3">
            <Link href="/login/Walikelas/home" className="text-decoration-none color red fw-bold text-info">
          ...
          <div className="mx-3">
            {" "}
            <Link href="/login" className="text-decoration-none color red fw-bold text-info">
      ...
      <div className=" bg-dark text-white shadow p-3 mb-5  rounded bg-opacity-50 p-5 w-50  position-absolute top-50 start-50 translate-middle ">
        <div className=" mb-3 row  ">
          <h1>Hi</h1>
          <h5>Silahkan Input Nilai dan Absensi Siswa</h5>
